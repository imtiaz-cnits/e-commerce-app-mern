                ...
                <div className="container">
                    <div className="row justify-content-around">
                        <div className="col-md-6">
                            <span>
                                <span className="f-12">
                                    <i className="bi bi-envelope"></i> support@gadgetstar.com
                                </span>
                                <span className="f-12 mx-2">
                                    <i className="bi bi-envelope"></i> 01788428280
                                </span>
                            </span>
                        </div>
                        <div className="col-md-6">
            ...
            <nav className="navbar  sticky-top bg-white navbar-expand-lg navbar-light py-3">
                <div className="container">
                    ...
                    <div className=" d-lg-flex">
                        ...
                        <Link type="button" className="btn ms-3 btn-danger d-flex" to="/profile">Profile</Link>
                        <Link type="button" className="btn ms-3 btn-danger d-flex" to="/profile">Logout</Link>
                    </div>
                </div>
            </nav>
        </>
